...
class MethodStatementController extends Controller
{
    ...
    public function store(Request $request, $permitNumber)
    {
        ...
        $validatedData = $request->validate([
            ...
            'work_access_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'safety_equipment_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'training_competency_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'route_identification_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'work_area_preparation_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'work_sequence_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'equipment_maintenance_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'platform_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'hand_washing_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
            'work_area_cleanliness_explanation' => $request->has('submit') ? 'required|string' : 'nullable|string',
