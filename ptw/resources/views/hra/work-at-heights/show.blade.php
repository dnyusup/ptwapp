    ...
    <div class="content-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center flex-wrap">
                ...
                @if($canEdit)
                <a href="{{ route('hra.work-at-heights.edit', [$permit, $hraWorkAtHeight]) }}" class="btn btn-warning" style="background-color: #ffc107; color: #000; border-color: #ffc107;">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ $photoUrl }}" target="_blank" data-bs-toggle="tooltip" title="Klik untuk melihat ukuran penuh">
                            <img src="{{ $photoUrl }}" alt="Work Area Photo" class="img-fluid rounded" style="max-height: 400px; cursor: pointer;" 
                                 onerror="this.style.display='none'; this.parentElement.innerHTML='<div class=\'alert alert-warning\'>Foto tidak dapat dimuat. Path: {{ $hraWorkAtHeight->work_area_photo }}</div>';">
                        </a>
