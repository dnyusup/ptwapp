        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2 align-items-center flex-wrap">
                ...
                @php
                    ...
                    $approvalStatus = $hraLotoIsolation->approval_status ?? 'draft';
                    $isDraft = $approvalStatus == 'draft';
                    $isRejected = $approvalStatus == 'rejected';
                    $isApproved = $approvalStatus == 'approved';
                    $isPending = $approvalStatus == 'pending';
                    
                    $isCreator = $currentUser && $hraLotoIsolation->user_id == $currentUser->id;
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ $photoUrl }}" target="_blank" data-bs-toggle="tooltip" title="Klik untuk melihat ukuran penuh">
                            <img src="{{ $photoUrl }}" alt="Work Area Photo" class="img-fluid rounded" style="max-height: 400px; cursor: pointer;" 
                                 onerror="this.style.display='none'; this.parentElement.innerHTML='<div class=\'alert alert-warning\'>Foto tidak dapat dimuat. Path: {{ $hraLotoIsolation->work_area_photo }}</div>';">
                        </a>
