    ...
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" action="{{ route('permits.store') }}" enctype="multipart/form-data">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-4 mt-2">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-between align-items-center">
                                    <label for="location_owner_id" class="form-label fw-semibold mb-0">
                                    ...
                                    <div class="form-check form-switch ms-2">
                                        <input class="form-check-input" type="checkbox" id="location_owner_as_approver" 
                                               name="location_owner_as_approver" value="1" {{ old('location_owner_as_approver', true) ? 'checked' : '' }}>
                                ...
                                <small class="text-muted" id="approver-hint">
                ...
                {{-- Risk Assessment & Method Statement Card removed - now shown in Request Approval popup --}}
