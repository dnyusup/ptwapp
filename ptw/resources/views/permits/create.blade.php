    ...
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" action="{{ route('permits.store') }}" enctype="multipart/form-data">
                ...
                <!-- Risk Assessment & Method Statement Card -->
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('risk_method_assessment') is-invalid @enderror" 
                                                   ...
                                                   {{ old('risk_method_assessment') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('risk_method_assessment') is-invalid @enderror" 
                                                   ...
                                                   {{ old('risk_method_assessment') == 'tidak' ? 'checked' : '' }} required>
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('chemical_usage_storage') is-invalid @enderror" 
                                                   ...
                                                   {{ old('chemical_usage_storage') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('chemical_usage_storage') is-invalid @enderror" 
                                                   ...
                                                   {{ old('chemical_usage_storage') == 'tidak' ? 'checked' : '' }} required>
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('equipment_condition') is-invalid @enderror" 
                                                   ...
                                                   {{ old('equipment_condition') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('equipment_condition') is-invalid @enderror" 
                                                   ...
                                                   {{ old('equipment_condition') == 'tidak' ? 'checked' : '' }} required>
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('asbestos_presence') is-invalid @enderror" 
                                                   ...
                                                   {{ old('asbestos_presence') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('asbestos_presence') is-invalid @enderror" 
                                                   ...
                                                   {{ old('asbestos_presence') == 'tidak' ? 'checked' : '' }} required>
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('atex_area') is-invalid @enderror" 
                                                   ...
                                                   {{ old('atex_area') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('atex_area') is-invalid @enderror" 
                                                   ...
                                                   {{ old('atex_area') == 'tidak' ? 'checked' : '' }} required>
                                    ...
                                    <div class="d-flex gap-3 ms-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('gas_storage_area') is-invalid @enderror" 
                                                   ...
                                                   {{ old('gas_storage_area') == 'ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input @error('gas_storage_area') is-invalid @enderror" 
                                                   ...
                                                   {{ old('gas_storage_area') == 'tidak' ? 'checked' : '' }} required>
