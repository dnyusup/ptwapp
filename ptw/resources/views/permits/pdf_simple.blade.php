...
<body>
    ...
    <!-- Completion Information Page (only if status is completed) -->
    ...
    <div class="page-break">
        ...
        <div class="section">
            ...
            <div class="row">
                <span class="label">Diselesaikan oleh:</span>
                <span>{{ $permit->completedBy->name ?? 'N/A' }}</span>
            </div>
            <div class="row">
                <span class="label">Tanggal Selesai:</span>
                <span>{{ $permit->completed_at->format('d M Y, H:i') }} WIB</span>
            </div>
        </div>
