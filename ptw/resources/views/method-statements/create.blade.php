...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getPersonDropdownHtml() {
        return `
            <select class="form-select responsible-person-select" name="responsible_persons[]" data-placeholder="Pilih responsible person...">
                <option value="">Pilih responsible person...</option>
                @foreach($users as $user)
    ...
    function getPersonFreeTextHtml() {
        return `
            <input type="text" class="form-control responsible-person-text" name="responsible_persons[]" placeholder="Masukkan nama personil...">
        `;
    }
            ...
            rows.forEach(row => {
                ...
                if (isFreeText) {
                    ...
                    if (currentSelect) {
                        ...
                        inputCell.innerHTML = getPersonFreeTextHtml();
                    }
                } else {
                    // Switch to dropdown
                    if (currentInput) {
